...
exports.UnitsModule = UnitsModule = __decorate([
    (0, common_1.Module)({
        imports: [(0, common_1.forwardRef)(() => dispatch_module_1.DispatchModule), (0, common_1.forwardRef)(() => realtime_module_1.RealtimeModule)],
        controllers: [units_controller_1.UnitsController],
        providers: [units_service_1.UnitsService, database_service_1.DatabaseService],
